...
This is the GitHub profile repo (`kevanwee/kevanwee`). It contains three generations of portfolio plus profile assets:

- `portfolio/` — **the live site** (Next.js 16 + Tailwind + three.js), deployed to https://kevanwee.vercel.app via Vercel. This is the only site under active development.
- Root `*.html` + `styles.css` — legacy static site, still served at https://kevanwee.github.io/kevanwee/ via GitHub Pages. Do not extend it; treat as frozen/legacy.
- `ssh-portfolio/` — Go/Bubble Tea SSH portfolio (see its `DEPLOY.md`).
