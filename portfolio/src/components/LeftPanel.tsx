    ...
    <aside className="lg:sticky lg:top-[var(--viewport-offset)] lg:flex lg:max-h-[calc(100vh-var(--viewport-offset))] lg:flex-col lg:justify-between lg:pb-24">
      ...
      <div className="pt-6">
        <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={onOpenModal}
            className="inline-flex items-center gap-2 rounded-full border border-cream-200 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-warm-400 transition-all duration-200 hover:border-sage-300 hover:text-sage-600"
