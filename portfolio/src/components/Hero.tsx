  ...
  return (
    <section className="flex min-h-screen flex-col justify-center px-6 pt-24 pb-16 md:px-10">
      <div className="mx-auto w-full max-w-4xl">
        {/* Eyebrow */}
        <p className="mb-6 flex items-center gap-3 text-xs font-medium uppercase tracking-widest text-warm-400">
          <span className="h-px w-8 bg-warm-300" />
          {personal.title} · {personal.institution}
        </p>

        {/* Name */}
        <h1 className="font-serif text-6xl font-bold leading-[1.05] tracking-tight text-warm-900 sm:text-7xl md:text-8xl">
        ...
        {/* Tagline */}
        <p className="mt-8 max-w-lg text-base leading-relaxed text-warm-500 sm:text-lg">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-3 pl-1">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-warm-400 transition-colors hover:text-sage-600"
            >
              <LinkedInIcon />
            </a>
            <a
