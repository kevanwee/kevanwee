            ...
            {experiences.map((exp) => {
              ...
              return (
                <button
                  ...
                  className={`relative whitespace-nowrap px-4 py-3 text-left text-xs transition-all duration-150 sm:w-44 sm:-ml-0.5 ${
                    isActive
                ...
                >
                  {exp.company.split(" ")[0] === "SMU"
                    ? exp.company.includes("Law")
                      ? "SMU Law"
                      : "SMU SCIS"
                    : exp.company.split(/[\s·]/)[0]}
                </button>
              );
            })}
          </div>
